...
- `number` entities for `Minimum SOC` and `Minimum SOC On Grid`
- `switch` entities to enable force-charge periods 1 and 2
- `time` entities to edit the start/end time for each force-charge period
